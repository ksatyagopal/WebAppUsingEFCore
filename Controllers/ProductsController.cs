...
namespace WebAppUsingEFCore.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var shoppingContext = _context.Products.Include(p => p.Supplier);
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,Cost,SupplierId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,ProductName,Cost,SupplierId")] Product product)
        {
